/**
 * AES-256-GCM credential encryption for Bot A's KV records (ARCHITECTURE.md
 * §8.6: per-chat AAD; raw secrets are never logged, echoed, or committed).
 *
 * Ported essentially verbatim from _legacy/telegram-bot/src/crypto.js — this
 * envelope format is also the relay sealed-envelope contract (§9.2), so the
 * AAD strings and envelope shape must not change.
 */
